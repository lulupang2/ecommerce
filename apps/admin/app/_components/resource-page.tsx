...
const configs = {
  ...
  products: { title: '상품 관리', eyebrow: 'PRODUCT INFORMATION', description: '상품, SKU, 모델번호, 가격과 판매 상태를 관리합니다.', endpoint: 'products', id: 'product_id', statusOptions: ['draft', 'published', 'hidden', 'archived'], defaultSort: 'created_at', primaryAction: { href: '/products/', label: '상품 등록' },
