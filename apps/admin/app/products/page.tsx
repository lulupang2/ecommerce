...
export default function ProductEditorPage() {
  ...
  const basicFields: any[] = [['상품명', 'name', 'text'], ['브랜드', 'brand', 'text'], ['카테고리', 'category', 'text'], ['색상·옵션', 'color', 'text']];
  const variantFields: any[] = [['SKU', 'sku', 'text'], ['모델번호', 'modelNumber', 'text'], ['바코드', 'barcode', 'text'], ['정가', 'listPrice', 'number'], ['판매가', 'price', 'number'], ['원가', 'costPrice', 'number'], ['중량(g)', 'weightGram', 'number'], ['초기 재고', 'stock', 'number']];
