...
const env = [
  ...
  { name: 'CART_URL', value: 'http://cart:3003' },
  { name: 'ORDER_URL', value: 'http://order:3004' },
  { name: 'PAYMENT_URL', value: 'http://payment:3005' },
  { name: 'INVENTORY_URL', value: 'http://inventory:3006' },
  { name: 'NOTIFICATION_URL', value: 'http://notification:3007' },
  { name: 'SEARCH_URL', value: 'http://search:3008' },
  { name: 'MEDIA_URL', value: 'http://media:3009' },
