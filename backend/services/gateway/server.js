...
const routes = [{prefix:'/api/auth',service:'auth'}, {prefix:'/api/admin',service:'admin'}, {prefix:'/api/storefront',service:'catalog'}, {prefix:'/api/products',service:'catalog'}, {prefix:'/api/reviews',service:'catalog'}, {prefix:'/api/wishlists',service:'catalog'}, {prefix:'/api/carts',service:'cart'}, {prefix:'/api/checkout',service:'order'}, {prefix:'/api/coupons',service:'order'}, {prefix:'/api/orders',service:'order'}, {prefix:'/api/payments',service:'payment'}, {prefix:'/api/inventory',service:'inventory'}, {prefix:'/api/fulfillment',service:'fulfillment'}, {prefix:'/api/procurement',service:'procurement'}, {prefix:'/api/notifications',service:'notification'}, {prefix:'/api/search',service:'search'}, {prefix:'/api/media',service:'media'}];
